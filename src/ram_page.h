...
// --- select only one of 'em
#ifdef SWAP_BLOCK_8k
#define RAM_PAGE_SIZE_KB 8ul
#define RAM_IN_PAGE_ADDR_MASK (0x00001FFF)
#endif
// --- select only one of 'em
#ifdef SWAP_BLOCK_16k
#define RAM_PAGE_SIZE_KB 16ul
...
#if PICO_ON_DEVICE
// CGA
#define RAM_SIZE (4 * 38ul << 10) // 38 pages 4Kb = 152KB real pico RAM
